...
<div class="page-header">
    ...
    <div class="info-box">
        ℹ️ Manage web authentication passwords
    </div>
</div>
...
<!-- Vezérlők -->
<div class="filters">
    <input type="text" id="passwordSearch" placeholder="🔍 Search users..." class="search-input">
    
    <select id="statusFilter" class="filter-select">
        <option value="">All Status</option>
        <option value="active">Active</option>
        <option value="expired">Expired</option>
        <option value="expired_24h">Expired ≤ 24h</option>
        <option value="expired_old">Expired > 24h</option>
    </select>
    
    <button class="btn btn-secondary" onclick="refreshDatabase()">🔄 Refresh</button>
    <button class="btn btn-primary" onclick="showGeneratePasswordModal()">🔑 Generate Password</button>
    <button class="btn btn-warning" onclick="exportDatabase()">📤 Export CSV</button>
    <button class="btn btn-danger" onclick="cleanupExpired()">🧹 Cleanup Expired</button>
    <button class="btn btn-danger" onclick="deleteOldExpired()" style="display: none;" id="deleteOldBtn">⚠️ Delete Old (>24h)</button>
</div>
...
<div class="dashboard-section">
    ...
    <div class="database-info">
        ...
        <p><strong>💡 Tip:</strong> You can also generate passwords via IRC using <code>!web</code> command.</p>
    </div>
</div>
...
<div class="form-group">
    ...
    <small class="form-text">Password validity period (⚠️ "Never expires" should be used with caution!)</small>
</div>
        ...
        <div id="generatedPasswordResult" style="display: none; margin-top: 20px; padding: 15px; background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 8px;">
            <h3 style="color: #155724; margin-bottom: 10px;">✅ Password Generated!</h3>
            ...
            <div style="margin-top: 15px; display: flex; gap: 10px;">
                ...
                <button class="btn btn-info" onclick="copyAllInfo()">📋 Copy All Info</button>
